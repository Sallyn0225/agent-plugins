---
"@sallyn0225/image-gen": major
---

Move image-gen into the Agent Plugins capability monorepo while preserving its package name, CLI commands, MCP tools, configuration schema, and Provider behavior.
